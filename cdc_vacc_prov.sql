...
DROP TABLE IF EXISTS cdc_vaccine_providers.providers;
DROP TABLE IF EXISTS cdc_vaccine_providers.location;
DROP TABLE IF EXISTS cdc_vaccine_providers.hours;
DROP TABLE IF EXISTS cdc_vaccine_providers.special_notes;

CREATE TABLE IF NOT EXISTS cdc_vaccine_providers.providers(
...
CREATE TABLE IF NOT EXISTS cdc_vaccine_providers.location(
...
CREATE TABLE IF NOT EXISTS cdc_vaccine_providers.hours(
...
CREATE TABLE IF NOT EXISTS cdc_vaccine_providers.special_notes(
